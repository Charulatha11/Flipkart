...
test('Amazon test', async ({ page }) => {
    ...
    const iphone17With46Rating = page.locator('//div[@data-cy="reviews-block"]//span[normalize-space()="4.6"] /ancestor::div[@role="listitem"][1] [.//div[@data-cy="title-recipe"][contains(., "iPhone 17")]]');
